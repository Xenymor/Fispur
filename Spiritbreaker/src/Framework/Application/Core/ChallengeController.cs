...
using static Spiritbreaker.Application.ConsoleHelper;
...
namespace Spiritbreaker.Application
{
    public class ChallengeController
    {
        ...
        void SetBoardPerspective()
        {
            ...
            else if (PlayerWhite.Bot is SpiritBreaker && PlayerBlack.Bot is SpiritBreaker)
            {
                boardUI.SetPerspective(true);
            }
            else
            {
                boardUI.SetPerspective(PlayerWhite.Bot is SpiritBreaker);
            }
        }
        ...
        ChessPlayer CreatePlayer(PlayerType type)
        {
            return type switch
            {
                ...
                PlayerType.SpiritBreaker => new ChessPlayer(new Spiritbreaker.SpiritBreaker0_10_0.SpiritBreaker0_10_0(), type, GameDurationMilliseconds),
        ...
        {
            string path = Path.Combine(Directory.GetCurrentDirectory(), "src", "SpiritBreaker-New", "SpiritBreaker.cs");
