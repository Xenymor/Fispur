...
using static FispurEngine.Application.ConsoleHelper;
...
namespace FispurEngine.Application
{
    public class ChallengeController
    {
        ...
        public ChallengeController()
        {
            ...
            StartNewGame(PlayerType.Human, PlayerType.Fispur_Exp);
        }
        ...
        void SetBoardPerspective()
        {
            ...
            else if (PlayerWhite.Bot is Fispur && PlayerBlack.Bot is Fispur)
            {
                boardUI.SetPerspective(true);
            }
            else
            {
                boardUI.SetPerspective(PlayerWhite.Bot is Fispur);
            }
        }
        ...
        ChessPlayer CreatePlayer(PlayerType type)
        {
            return type switch
            {
                ...
                PlayerType.Fispur => new ChessPlayer(new FispurEngine.Fispur0_13_2.Fispur0_13_2(), type, GameDurationMilliseconds),
        ...
        {
            string path = Path.Combine(Directory.GetCurrentDirectory(), "src", "Fispur-New", "Fispur.cs");
