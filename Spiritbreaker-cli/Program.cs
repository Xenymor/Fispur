...
internal class Program
{
    ...
    {
        IChessBot spiritBreaker = new Spiritbreaker.SpiritBreaker0_7_0.SpiritBreaker0_7_0();
        Type botType = spiritBreaker.GetType();
        int hashMb = Spiritbreaker.SpiritBreaker0_7_0.SpiritBreaker0_7_0.DEFAULT_HASH_MB;
            ...
            switch (tokens[0])
            {
                case "uci":
                    ...
                    Console.WriteLine("option name Hash type spin default "
                        + Spiritbreaker.SpiritBreaker0_7_0.SpiritBreaker0_7_0.DEFAULT_HASH_MB
                        + " min 1 max " + Spiritbreaker.SpiritBreaker0_7_0.SpiritBreaker0_7_0.MAX_HASH_MB);
                ...
                case "setoption":
                    {
                        ...
                        if (nameIdx != -1 && valueIdx > nameIdx)
                        {
                            ...
                            {
                                hashMb = Math.Clamp(mb, 1, Spiritbreaker.SpiritBreaker0_7_0.SpiritBreaker0_7_0.MAX_HASH_MB);
                                (spiritBreaker as Spiritbreaker.SpiritBreaker0_7_0.SpiritBreaker0_7_0)?.SetHashSize(hashMb);
                            }
                        }
                    }
                    break;
                ...
                case "ucinewgame":
                    if (spiritBreaker is Spiritbreaker.SpiritBreaker0_7_0.SpiritBreaker0_7_0 currentBot)
                    {
                        currentBot.NewGame();
                    }
                    else
